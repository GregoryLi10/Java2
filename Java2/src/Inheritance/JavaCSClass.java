...
public class JavaCSClass extends CSClass {
	...
	public static void main (String[] args) {
		Student[] students={new Student(15, 15, "Gregory", 3), new Student(16, 7, "Anika", 4), new Student(14, 7, "Ian", 3), new Student(15, 10, "Cooper", 3)};
		Human teacher=new Human(100, 100, "Friedman");
		JavaCSClass a=new JavaCSClass(students, teacher, 3);
